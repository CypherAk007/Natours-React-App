    ...
    return (
        <div className={`${classes['story']} relative mt-32 w-[75%] p-[6rem] pl-[9rem] -skew-x-12 bg-white`}>
            <figure className={`${classes['story-shape']}   h-[15rem] w-[15rem]  float-left`}>
                ...
                <figcaption className={`text-white block text-[1.7rem] uppercase absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] text-center opacity-100 hover:opacity-0`}>Aldo</figcaption>
            </figure>
